    ...
    <div className="text-white bg-[#412249] min-h-screen font-[roboto]">
      <div className="pt-20">
        <h2 className="text-3xl font-semibold text-center">
          Student Nirgam Certificate Details
        </h2>
          ...
          {showPreview && (
            ...
            >
              ...
              <div>
                ...
                <p>
                  <strong>GR No.:</strong> {formData.grNo}
                </p>
                <p>
                  <strong>Standard Admitted:</strong> {formData.stdAdmitted}
                </p>
                <p>
                ...
                <p>
                  <strong>Standard Studying:</strong> {formData.stdStudying}
                </p>
                <p>
                  <strong>Class Leaving:</strong> {formData.classLeaving}
                </p>
                <p>
                  <strong>Date of Leaving:</strong> {formData.dateLeaving}
                </p>
                <p>
                  <strong>Reason for Leaving:</strong> {formData.reasonLeaving}
                </p>
                <p>
                ...
                <p>
                  <strong>Caste:</strong>{" "}
                  {caste.find((cast) => cast.id === selectedOption2)?.name ||
                    "N/A"}
                </p>
              </div>
            </div>
