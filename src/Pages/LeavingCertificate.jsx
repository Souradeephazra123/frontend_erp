                ...
                <div className="m-12 p-12 border-4 border-black">
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <div className="mb-12">
                      ...
                      <p className="text-center font-semibold">
                        UDISE No.: 27160301903 AffiliaƟon No.: 1131230 School
                        Code: 31217
                      </p>
                      <div className="text-center font-semibold">
                        <a href="/www.induraenglishschool.in" className="mx-4">
                          Website : www.induraenglishschool.in
                        </a>
                        <a
                          href="/induraenglishschool@gmail.com"
                          className="mx-4"
                        >
                  ...
                  <div className="flex justify-center font-semibold text-[0.8rem] items-center mt-4">
                    <div className="vertical-table-container">
                      <div className="vertical-table-header">
                        {Object.keys(formData).map((field) => (
                          <div key={field} className="vertical-header-item">
                            {field
                              .split(/(?=[A-Z])/)
                              .join(" ")
                              .toUpperCase()}
