...
function History() {
  ...
  const data = [
    { month: 'May', absent: '3 days', present: '7 days', workingDays: '15 days' },
    { month: 'June', absent: '15 days', present: '7 days', workingDays: '15 days' },
    { month: 'July', absent: '2 days', present: '15 days', workingDays: '15 days' },
    { month: 'August', absent: '4 days', present: '15 days', workingDays: '15 days' },
    { month: 'September', absent: '3 days', present: '7 days', workingDays: '15 days' }
  ];
  ...
  return (
    <div className="p-4 bg-[#CBE4FD] rounded-lg shadow-md">
      ...
      <table className="min-w-full bg-[#CBE4FD] rounded-md">
        ...
        <tbody>
          {data.map((row, index) => (
            <tr key={index} className={index % 2 === 0 ? 'bg-[#CBE4FD]' : 'bg-[#CBE4FD]'}>
