...
function TeacherAdd() {
  return (
    <div>
        <h1 className="text-lg text-center p-6 bg-[#CBE4FD] font-semibold text-gray-700">Teacher Attendance</h1>
    ...
    <div className="max-w-full mx-auto p-6 bg-white  space-y-6">
      ...
      <div className=" p-6  text-center">
          <h3 className="text-md font-semibold text-gray-700 mb-2">Time Out</h3>
          <p className=" p-2 bg-[#CBE4FD] rounded font-semibold text-gray-900">05:00 PM</p>
        </div>
        <div className=" p-6  text-center">
          <h3 className="text-md font-semibold text-gray-700 mb-2">Time Out</h3>
          <p className=" p-2 bg-[#CBE4FD] rounded font-semibold text-gray-900">05:00 PM</p>
      ...
      {/* Attendance Section */}
      <div>
        <h1 className="text-2xl font-semibold text-gray-700 mb-4">Attendance status</h1>
