  ...
  return (
    <div className="max-w-7xl mx-auto p-6 mt-4 mb-32 bg-[#CBE4FD] rounded-lg shadow-lg space-y-8">
      ...
      <div className="flex justify-between items-center space-x-4">
        ...
        <button className="ml-auto bg-white text-black px-6 py-2 rounded-full 0">
          Edit
        </button>
      </div>
      ...
      <div className="flex justify-center space-x-4">
        <button className=" border-black text-black font-semibold px-24 border-2 py-2 rounded-lg ">
          Cancel
        </button>
        <button className="bg-[#284766C4] text-white px-24 py-2 rounded-lg border-2 p-4 ">
          Save
        </button>
      </div>
    </div>
